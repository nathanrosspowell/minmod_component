...
class ComponentFactory
{
  public:
      ...
      static std::shared_ptr< ComponentInterface > Create( ComponentInterface::Id id );
      static std::shared_ptr< ComponentInterface > Create( std::string name );

  private:
      static std::unordered_map< std::string, ComponentInterface::Id> ms_stringMap;
      static std::unordered_map< ComponentInterface::Id, CreateFunction > ms_map;
};
